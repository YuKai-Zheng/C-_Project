...
namespace CSLL {
    ...
    const static char* Cell_Icon_Res = "v66/CSLL/type/LT_%02d.png";

	CSLLScorePanelCellV88::CSLLScorePanelCellV88() {
    }

	CSLLScorePanelCellV88::~CSLLScorePanelCellV88() {
    }

	bool CSLLScorePanelCellV88::init() {
        if (!Layer::init()) {
            return false;
        }
	...
	void CSLLScorePanelCellV88::initDefaultUI() {
	...
	void CSLLScorePanelCellV88::setCellValue(int type, int rate, int totalRate, int textType) {
		char name[128] = { 0 };
