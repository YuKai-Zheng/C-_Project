...
namespace Tiger {
    ...
    const static char* Cell_Icon_Res = "Games/Tiger/type/%02d.png";

	TigerScorePanelCellV88::TigerScorePanelCellV88() {
    }

	TigerScorePanelCellV88::~TigerScorePanelCellV88() {
    }

	bool TigerScorePanelCellV88::init() {
        if (!Layer::init()) {
            return false;
        }
	...
	void TigerScorePanelCellV88::initDefaultUI() {
	...
	void TigerScorePanelCellV88::setCellValue(int type, int rate, int totalRate, int textType) {
		char name[128] = { 0 };
