#pragma once
#ifndef __Tiger_COMMON_DEFINE_h__
#define __Tiger_COMMON_DEFINE_h__
...
#define LOTTERY_COUNT_Tiger      15                  //3行5列，共15格子
...
//#define PRIZE_TYPE_COUNT                3                     //返奖类型：底注倍数、免费次数、奖池百分比
    ...
    struct struct_s2c_game_begin
    {
        ...
        int nOpenLotteryType[LOTTERY_COUNT_Tiger];        //每个格子的水果
