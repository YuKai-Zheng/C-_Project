...
#ifndef BBSettlementV99_h
#define BBSettlementV99_h
...
namespace BB {
    ...
    class BBSettlementV99 : public Layer {
    ...
    public:
        ...
        void updateMyName(char name[61]);
