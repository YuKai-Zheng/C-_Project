...
namespace Pubg {
    ...
    const static char* Cell_Icon_Res = "Games/31000509/type/%02d.png";

	PubgScorePanelCellV88::PubgScorePanelCellV88() {
    }

	PubgScorePanelCellV88::~PubgScorePanelCellV88() {
    }

	bool PubgScorePanelCellV88::init() {
        if (!Layer::init()) {
            return false;
        }
	...
	void PubgScorePanelCellV88::initDefaultUI() {
	...
	void PubgScorePanelCellV88::setCellValue(int type, int rate, int totalRate, int textType) {
		char name[128] = { 0 };
