#pragma once
#ifndef __MEDUSA_COMMON_DEFINE_h__
#define __MEDUSA_COMMON_DEFINE_h__
...
#define LINE_COUNT              50                   //最高连线数
//#define LOTTERY_TYPE_COUNT                  14                  //水果类型数
#define LOTTERY_COUNT           15                  //3行5列，共15格子
...
//#define PRIZE_TYPE_COUNT                3                     //返奖类型：底注倍数、免费次数、奖池百分比
    ...
    struct struct_s2c_game_begin
    {
        ...
        int nOpenLotteryType[LOTTERY_COUNT];        //每个格子的水果
        ...
        BYTE bHasMedusa;                            //最后两列出现美杜莎
        BYTE bIsPetrified;                          //生物（士兵）被石化
