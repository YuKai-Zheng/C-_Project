...
namespace Medusa  {
	...
	SettlementV88::SettlementV88() {
    }
    
	SettlementV88::~SettlementV88() {
    }
    
	bool SettlementV88::init() {
        if (!Layer::init()) {
            return false;
        }
    ...
    void SettlementV88::showSettleLayerAndUpdateData(struct_s2c_game_begin msg) {
        int count=0;
        m_totalRate = 0;
        scoreCellVec.clear();
    ...
    void SettlementV88::hideSettleLayer() {
    ...
    void SettlementV88::initSettleLayer() {
        m_audioEffectID = 0;
        m_root = nullptr;
        m_action = nullptr;
        scoreCellVec.clear();
