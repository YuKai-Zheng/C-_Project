#ifndef MedusaGameTableUIV88_h
#define MedusaGameTableUIV88_h

#include <string>
#include "cocos2d.h"
#include "cocostudio/CocoStudio.h"
#include "extensions/cocos-ext.h"
#include "MedusaGameTableUICallback.h"
//#include "UI/Base/AUIButton.h"
//#include "../../TTNN/Classes/v88/BRNNClockV88.h"
#include "MedusaGameTableLogic.h"
//#include "GuessSizeV88.h"
#include "MedusaSettlementV88.h"
//#include "MaryTableUIV88.h"
...
namespace Medusa {
	...
	class GameTableUIV88 : public GameTableUICallback {
        ...
        struct Root_UI {
            ...
            void EnableButtons(bool flag)
            {
                ...
                if (nineLine)
                {
                    nineLine->setTouchEnabled(flag);
                    nineLine->setBright(flag);
                }
	...
	public:
        ...
        void showEffectAnimation(int index,Node * parentNode);
        //
        //消息同步
...
//        Node*               root;
		...
		int 				nOpenLotteryType[LOTTERY_COUNT];			//服务端发送的15个图标
        ...
        int                    bHasMedusa; //最后两列出现美杜莎
        int                    bIsPetrified;//生物被石化
        //基础信息同步
...
//        void showOpenBtn(float dt);
	...
	private:
        ...
        void createLineSelectMenu(Button* menu);
        ...
        void updateMedusaSh();  //美杜莎出现和士兵石化
    private:
