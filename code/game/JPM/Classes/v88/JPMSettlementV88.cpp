...
#include "JPM/Classes/v88/JPMSettlementV88.h"
#include "JPM/Classes/v88/JPMGameTableUIV88.h"
...
namespace JPM {
	...
	JPMSettlementV88::JPMSettlementV88() {
    }
    
	JPMSettlementV88::~JPMSettlementV88() {
    }
    
	bool JPMSettlementV88::init() {
        if (!Layer::init()) {
            return false;
        }
    ...
    void JPMSettlementV88::showSettleLayerAndUpdateData(struct_s2c_game_begin msg) {
        int count=0;
        m_totalRate = 0;
        scoreCellVec.clear();
        for (int i = 0; i < LINE_COUNT; i++) {
            /*if (msg.nOpenLineLotteryType[i] != -1) {
                JPMScorePanelCellV88* newCell = JPMScorePanelCellV88::create();
    ...
    void JPMSettlementV88::hideSettleLayer() {
    ...
    void JPMSettlementV88::initSettleLayer() {
        m_audioEffectID = 0;
        m_root = nullptr;
        m_action = nullptr;
        scoreCellVec.clear();
