...
//                HNLog::logInfo("Receive Game State: %d", _gameStatus);
...
//                HNLog::logInfo("Receive Game Base Info: %d", msg->i64Jackpot);
...
//                HNLog::logInfo("Received Game Begin: %d %d", msg->i64MyMoney, msg->i64WinMoney);
...
//                HNLog::logInfo("Received Game Finished: %d Win: %d JackPot: %d", msg->i64MyMoney, msg->i64WinMoney, msg->i64Jackpot);
