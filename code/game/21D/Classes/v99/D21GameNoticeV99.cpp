...
namespace D21
{
	...
	GameNoticeV99::GameNoticeV99(void) :_bg(nullptr)
	{
	}


	GameNoticeV99::~GameNoticeV99(void)
	{
	}

	GameNoticeV99* GameNoticeV99::create(cocos2d::Node* parent, std::string context, std::string title, std::string fileName )
	{
		GameNoticeV99* ptr = new GameNoticeV99();
	...
	bool GameNoticeV99::init(cocos2d::Node* parent, std::string& context, std::string& title, std::string& fileName)
	{
		if (!HNLayer::init())
		{
			return false;
