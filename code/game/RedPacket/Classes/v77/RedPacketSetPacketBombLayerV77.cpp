//
//  RedPacketSetPacketBombLayerV77.cpp
//  MixProject_189
//
...
namespace RedPacket {
    ...
    RedPacketSetPacketBombLayerV77::RedPacketSetPacketBombLayerV77() {
    ...
    bool RedPacketSetPacketBombLayerV77::init() {
        if (!Layer::init()) {
            return false;
        }
    ...
    void RedPacketSetPacketBombLayerV77::openAddToParent(RedPacket::RedPacketSendPacketLayerV77 *parent, Vec2 pos, int bombNumber) {
        if (parent) {
    ...
    void RedPacketSetPacketBombLayerV77::resetData() {
        m_bg = nullptr;
    ...
    void RedPacketSetPacketBombLayerV77::createUI() {
            ...
            if (m_selectBombList) {
                ...
                if (kuang) {
                    ...
                    if (m_closeButton) {
                        ...
                        m_closeButton->addTouchEventListener(CC_CALLBACK_2(RedPacketSetPacketBombLayerV77::closeButtonCallBack, this));
...
//                    }
    ...
    void RedPacketSetPacketBombLayerV77::closeLayer() {
    ...
    void RedPacketSetPacketBombLayerV77::setListViewSelectedItem(int selectedItem) {
    ...
    void RedPacketSetPacketBombLayerV77::closeButtonCallBack(cocos2d::Ref *pSender, Widget::TouchEventType type) {
