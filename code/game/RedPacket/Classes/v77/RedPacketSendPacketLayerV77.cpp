//
//  RedPacketSendPacketLayerV77.cpp
//  MixProject_VIP
//
...
#include "RedPacketSetPacketBombLayerV77.h"
...
namespace RedPacket {
    ...
    RedPacketSendPacketLayerV77::RedPacketSendPacketLayerV77() {
    ...
    bool RedPacketSendPacketLayerV77::init() {
        if (!Layer::init()) {
            return false;
        }
    ...
    void RedPacketSendPacketLayerV77::editBoxReturn(ui::EditBox *editBox) {
        if (editBox) {
    ...
    void RedPacketSendPacketLayerV77::openAddToParent(HNLayer *parent, cocos2d::Vec2 pos) {
        if (parent) {
    ...
    void RedPacketSendPacketLayerV77::setBombNumber(int number) {
        if (m_bombButton) {
    ...
    void RedPacketSendPacketLayerV77::setSendPacketCallBack(std::function<void (LLONG packetMoney, int packetPart, int thunderNumber)> callBack) {
        m_sendPacketCallBack = callBack;
    }
    
    void RedPacketSendPacketLayerV77::updateRoomBaseData(RedPacket::tag_s2c_BaseConfigMsgReq baseData) {
    ...
    void RedPacketSendPacketLayerV77::resetData() {
        m_bg = nullptr;
...
//        m_helpButton = nullptr;
    ...
    void RedPacketSendPacketLayerV77::createUI() {
        ...
        if (m_bg) {
            ...
            if (m_closeButton) {
                ...
                m_closeButton->addTouchEventListener(CC_CALLBACK_2(RedPacketSendPacketLayerV77::backButtonCallBack, this));
...
//                m_helpButton->addTouchEventListener(CC_CALLBACK_2(RedPacketSendPacketLayerV77::helpButtonCallBack, this));
...
//            }
            ...
            if (m_sendButton) {
                ...
                m_sendButton->addTouchEventListener(CC_CALLBACK_2(RedPacketSendPacketLayerV77::sendButtonCallBack, this));
            ...
            if (m_packetBombBG) {
                ...
                if (m_bombButton) {
                    ...
                    m_bombButton->addTouchEventListener(CC_CALLBACK_2(RedPacketSendPacketLayerV77::setBombCallBack, this));
    ...
    void RedPacketSendPacketLayerV77::closeLayer() {
        this->removeFromParent();
    }
    
    void RedPacketSendPacketLayerV77::backButtonCallBack(cocos2d::Ref *pSender, Widget::TouchEventType type) {
...
//    void RedPacketSendPacketLayerV77::helpButtonCallBack(cocos2d::Ref *pSender, Widget::TouchEventType type) {
//        if (type != Widget::TouchEventType::ENDED) {
//            return;
//        }
//    }
    
    void RedPacketSendPacketLayerV77::sendButtonCallBack(cocos2d::Ref *pSender, Widget::TouchEventType type) {
        if (type != Widget::TouchEventType::ENDED) {
            return;
        }
    ...
    void RedPacketSendPacketLayerV77::setBombCallBack(cocos2d::Ref *pSender, Widget::TouchEventType type) {
        if (type != Widget::TouchEventType::ENDED) {
            return;
        }
        auto setBomb = RedPacketSetPacketBombLayerV77::create();
        if (setBomb) {
