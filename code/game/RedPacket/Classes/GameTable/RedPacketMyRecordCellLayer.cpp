//
//  RedPacketMyRecordCellLayer.cpp
//  MixProject_VIP
//
...
namespace RedPacket {
    ...
    RedPacketMyRecordCellLayer::RedPacketMyRecordCellLayer() {
    ...
    bool RedPacketMyRecordCellLayer::init() {
        if (!Layout::init()) {
            return false;
        }
    ...
    Size RedPacketMyRecordCellLayer::getContentSize() {
        return m_contentSize;
    }
    
    void RedPacketMyRecordCellLayer::setHistoryCellData(RedPacket::tag_s2c_MyHistoryRobLogReq *data) {
        if (data) {
    ...
    void RedPacketMyRecordCellLayer::resetData() {
    ...
    void RedPacketMyRecordCellLayer::createUI() {
    ...
    std::string RedPacketMyRecordCellLayer::moneyWithCharactor(LLONG money) {
        char str[64];
        memset(str, 0, sizeof(str));
        if (money > 0) {
