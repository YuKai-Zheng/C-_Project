//
//  RedPacketOpenDetailCellLayer.cpp
//  MixProject_VIP
//
...
namespace RedPacket {
    ...
    RedPacketOpenDetailCellLayer::RedPacketOpenDetailCellLayer() {
    ...
    bool RedPacketOpenDetailCellLayer::init() {
        if (!Layout::init()) {
            return false;
        }
    ...
    void RedPacketOpenDetailCellLayer::setHead(UserInfoStruct *user) {
        if (!user) {
            if (m_userHead)
    ...
    void RedPacketOpenDetailCellLayer::setOpenPacketPlayerInfo(RobRedPacketUserInfo* info) {
        if (info) {
    ...
    Size RedPacketOpenDetailCellLayer::getContentSize() {
        return m_contentSize;
    }
    
    void RedPacketOpenDetailCellLayer::resetData() {
        m_userHead = nullptr;
        m_userName = nullptr;
        m_time = nullptr;
    ...
    void RedPacketOpenDetailCellLayer::createUI() {
