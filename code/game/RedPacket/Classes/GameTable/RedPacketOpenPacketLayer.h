...
#ifndef RedPacketOpenPacketLayer_h
#define RedPacketOpenPacketLayer_h
...
namespace RedPacket {
    class RedPacketOpenPacketLayer : public Layer {
    public:
        RedPacketOpenPacketLayer();
        ~RedPacketOpenPacketLayer();
        CREATE_FUNC(RedPacketOpenPacketLayer);
...
#endif /* RedPacketOpenPacketLayer_h */
