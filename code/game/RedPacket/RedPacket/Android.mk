...
$(call import-add-path,$(LOCAL_PATH)/../../MixProject/Classes)

LOCAL_MODULE := RedPacket_static

LOCAL_MODULE_FILENAME := libRedPacket
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../MixProject/Classes	\
