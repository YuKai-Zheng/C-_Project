...
namespace NL {
	...
	NLScorePanelCellV88::NLScorePanelCellV88() {
    }

	NLScorePanelCellV88::~NLScorePanelCellV88() {
    }

	bool NLScorePanelCellV88::init() {
        if (!Layer::init()) {
            return false;
        }
	...
	void NLScorePanelCellV88::initDefaultUI() {
	...
	void NLScorePanelCellV88::setCellValue(int type, int rate, int totalRate, int textType) {
		char name[128] = { 0 };
