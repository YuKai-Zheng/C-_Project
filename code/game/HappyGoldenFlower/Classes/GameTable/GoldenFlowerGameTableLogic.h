...
namespace goldenflower
{
	...
	protected:
        ...
        //玩家金币不足提醒
        void dealUserLackMoneyTipResp(void* object, INT objectSize);

		//	更新下注金额
		void dealBetValueResultResp(void* object, INT objectSize);
	...
	public:
		...
		// 坐下
		void sendUserSit(BYTE byDeskStation) override;
