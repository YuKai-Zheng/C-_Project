#ifndef __GoldenFlowerGame_Dealer_UI_V88_H__
#define __GoldenFlowerGame_Dealer_UI_V88_H__
...
class GameDelearUIV88: public HN::HNLayer
{
public:
	/*创建荷官*/
	static GameDelearUIV88* create();
	/*设置荷官位置（初始化一次）*/
	...
	//玩家下注  moneyType 代表筹码索引  从0到4分别为  100   1000 10000  100000 1000000   采用固定金额
	void betMoney(BYTE seatNo, int moneyType);
...
private:
	...
	PokerCardV88* _cardSuite[52]; // card suite
	static const int TOTAL_CARDS = 52; // total cards

	DrawEllipseV88* _ellipse; // a ellipse area used for chips pool
	cocos2d::Layer* _chipsPool; // chips pool for chip recycle
};
}

#endif //__GoldenFlowerGame_Dealer_UI_V88_H__