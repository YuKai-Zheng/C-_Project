#ifndef __FQZS_GameTable_NNTableUIV88_h__
#define __FQZS_GameTable_NNTableUIV88_h__
...
private:
    ...
    struct Bet_Area {
        ...
        AUIButton*		clearBtn;		//清空下注按钮
        AUIButton*		resetBtn;		//续注按钮
        Sprite*			myGoldSprite;	//
        Sprite*			myWinSprite;	//
...
//    void playBigWinAnimation(BYTE index, LLONG money);
