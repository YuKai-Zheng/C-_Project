#ifndef __SHZ_GameTableLogic_h__
#define __SHZ_GameTableLogic_h__
...
namespace SHZ
{
    ...
    public:
        ...
        //开始
		void sendStart(long long betMoney);
        //自动
        void sendAutoGame();
        //猜大小
		void sendGuessNumber(int guessNum, int isGuess);
		//是否猜大小
		void sendIsGuessSize(int isGuessSize);
