#pragma once
#ifndef __Honor_COMMON_DEFINE_h__
#define __Honor_COMMON_DEFINE_h__
...
#define LOTTERY_COUNT_Honor      20                  //4行5列，共20格子
...
#define FINAL_KILL_COUNT       9  //大逃杀最大击杀数
    ...
    struct struct_s2c_game_begin
    {
        ...
        int nOpenLotteryType[LOTTERY_COUNT_Honor];        //每个格子的水果
    ...
    struct struct_s2c_finalmode_result
    {
        ...
        int nOpenLotteryType[LOTTERY_COUNT_Honor];    //本局的开奖图案
