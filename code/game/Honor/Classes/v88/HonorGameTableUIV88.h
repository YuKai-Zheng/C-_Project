...
#ifndef HonorGameTableUIV88_h
#define HonorGameTableUIV88_h

#include <string>
#include "cocos2d.h"
#include "cocostudio/CocoStudio.h"
#include "extensions/cocos-ext.h"
#include "../GameTable/HonorGameTableUICallback.h"
//#include "UI/Base/AUIButton.h"
//#include "../../TTNN/Classes/v88/BRNNClockV88.h"
#include "HonorGameTableLogic.h"
...
//        int                 m_GameStatus;
		HonorSettlementV88*    _gameSettlement;
...
//        Node*               root;
		...
		int 				nOpenLotteryType[LOTTERY_COUNT_Honor];			//服务端发送的15个图标
...
//        long long i64MyMoney;
		...
		spine::SkeletonAnimation* m_skeletonGame;
		spine::SkeletonAnimation* m_skeletonGameFire;
    ...
    private:
		...
		void setViewVisible(bool bSmallGame = true);	//是否进入小游戏
    };
}
