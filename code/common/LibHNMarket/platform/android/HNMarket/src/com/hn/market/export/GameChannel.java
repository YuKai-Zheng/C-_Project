...
public class GameChannel {
	...
	private native String payCB(String ID, boolean result, String args);

	private native String responseChannel(String callback, String args);
	...
	public static String requestChannel(String moudleName, String function, String args, String callback) {
		return ChannelExport.getInstance().requestChannel(moudleName, function, args, callback);
	}

	public static void pay(String productInfo) {
...
//		activity.startActivityForResult(intent, Constant.COMMOAND_PAY_RESULT);
	...
	public String notifyPayCB(Object object) {
		...
		try {
			...
			return payCB(identifier, status == 1, json.toString());
	...
	public String notifyResponseChannel(Object object) {
		ResponseArgs pragma = (ResponseArgs) object;
		return responseChannel(pragma.getCallBack(), pragma.getArgs());
	}
