...
public class HNPayActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		product_description.setText(String.format("商品： %d金币", product.number));
		...
		Log.i("price", "price:"+product.price);
		...
		aliPay.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {	
				...
				alipay.pay(String.format("%d金币", product.number), 
						String.format("%.2f元购买%d金币", product.price, product.number), 
						String.format("%.2f", product.price), product.orderID,product.IP,
