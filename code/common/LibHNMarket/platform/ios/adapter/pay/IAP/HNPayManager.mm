...
#include "../../../../../../LibHNNet/HNNetProtocol/HNBaseCommand.h"
...
namespace HN
{
    ...
    {
        resisterAyncMethod("pay", HN_CALLFUNC_SELECTOR(PayManager::pay));
        resisterAyncMethod("login", HN_CALLFUNC_SELECTOR(PayManager::login));
        resisterAyncMethod("logout", HN_CALLFUNC_SELECTOR(PayManager::logout));
        resisterAyncMethod("restore", HN_CALLFUNC_SELECTOR(PayManager::restore));
    ...
    void PayManager::registerPay(PayModule* payModule)
...
//                                const std::string& appKey)
    {
        ...
        const std::string appId = getAppId();
        const std::string appKey = getAppShareKey();
