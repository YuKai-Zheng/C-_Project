...
# error                                                         ^ read comments above, fix accordingly, and remove this #error line
    ...
    // both space and time by combining a value unique to the computer on which it was generated鈥攗sually the
    // Ethernet hardware address鈥攁nd a value representing the number of 100-nanosecond intervals since 
