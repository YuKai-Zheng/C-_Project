...
void HNLayer::onEnter() {
    ...
    if (mAutoClose) {
        ...
        myListener->onTouchBegan = CC_CALLBACK_2(HNLayer::onTouchBegan, this);
        myListener->onTouchMoved = CC_CALLBACK_2(HNLayer::onTouchMoved, this);
        myListener->onTouchEnded = CC_CALLBACK_2(HNLayer::onTouchEnded, this);
...
bool HNLayer::onTouchBegan(Touch *touch, Event *unused_event) {
...
void HNLayer::onTouchMoved(Touch *touch, Event *unused_event) {
}

void HNLayer::onTouchEnded(Touch *touch, Event *unused_event) {
}