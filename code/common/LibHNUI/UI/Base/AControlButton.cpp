...
AControlButton* AControlButton::create(const char* filename) {
    ui::Scale9Sprite* sprite = ui::Scale9Sprite::create(filename);
...
void AControlButton::gray() {
    ...
    getBackgroundSprite()->setState(Scale9Sprite::State::GRAY);
}

void AControlButton::recovery() {
    GraphicsUtils::recovery(_children);
    getBackgroundSprite()->setState(Scale9Sprite::State::NORMAL);
}
