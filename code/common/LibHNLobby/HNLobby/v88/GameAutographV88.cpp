...
static char* BACKGROUND = "v88/set_bank/set/qianming/qianmin.png";   //输入背景框
static char* BUTTON_OK = "v88/button/green/bg.png";
static char* BUTTON_TITLE = "v88/button/green/4.png";

#define WINSIZE Director::getInstance()->getWinSize()

AutoGraphV88::AutoGraphV88()
{
}
AutoGraphV88::~AutoGraphV88()
{
...
bool AutoGraphV88::init()
{
	...
	_ok->addTouchEventListener(CC_CALLBACK_2(AutoGraphV88::buttonCallBack, this));
	this->addChild(_ok);

	PlatformLogic()->addEventSelector(MDM_GP_USERINFO, ASS_GP_USERINFO_ACCEPT, HN_SOCKET_CALLBACK(AutoGraphV88::modifyOKSelector, this));
	PlatformLogic()->addEventSelector(MDM_GP_USERINFO, ASS_GP_USERINFO_NOTACCEPT, HN_SOCKET_CALLBACK(AutoGraphV88::modifyNoSelector, this));
	PlatformLogic()->addEventSelector(MDM_GP_USERINFO, ASS_GP_USERINFO_NOTACCEPT_BADWORD, HN_SOCKET_CALLBACK(AutoGraphV88::modifyFailureSelector, this));

	return true;
}

void AutoGraphV88::textFieldEvent(Ref *pSender, TextField::EventType type)
{


}

bool AutoGraphV88::modifyOKSelector(HNSocketMessage* socketMessage)
{
...
bool AutoGraphV88::modifyNoSelector(HNSocketMessage* socketMessage)
{
	//CCAssert(sizeof (MSG_GP_UserInfo) == socketMessage->objectSize, "MSG_GP_R_BindMobile is error.");
	//if (socketMessage->objectSize != sizeof(MSG_GP_UserInfo)) return true;
...
bool AutoGraphV88::modifyFailureSelector(HNSocketMessage* socketMessage)
{
	GamePromptLayer::create()->showPrompt(GetText("Sign_Default"));
	return true;
}

void AutoGraphV88::buttonCallBack(Ref*pShender, Widget::TouchEventType type)
{
