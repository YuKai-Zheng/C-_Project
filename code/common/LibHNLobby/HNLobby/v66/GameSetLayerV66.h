#ifndef __GAMESET_LAYERV66_H__
#define __GAMESET_LAYERV66_H__
...
class GameSetLayerV66 : public IGameSet, public ui::EditBoxDelegate {
...
public:
    GameSetLayerV66();
    virtual ~GameSetLayerV66();

public:
    virtual bool init() override;
    CREATE_FUNC(GameSetLayerV66);
public:
